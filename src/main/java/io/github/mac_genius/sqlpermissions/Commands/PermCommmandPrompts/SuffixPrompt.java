 ...
 */
public class SuffixPrompt extends StringPrompt {
    private PermGroup permGroup;
    private PluginSettings settings;

    public SuffixPrompt(PermGroup permGroup, PluginSettings settings) {
    ...
    public String getPromptText(ConversationContext conversationContext) {
        return ChatColor.BLUE + "[SQLPermissions]" + ChatColor.WHITE + " What will the suffix be?"
    ...
    public Prompt acceptInput(ConversationContext conversationContext, String s) {
        return new DefaultPrompt(permGroup, settings);
    }
}
